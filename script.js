/* === BUG ===
//DONE bug 1 = cant double click operator
//DONE bug 2 = cant do multiple calculation at once
//DONE bug 3 = cant do calculation after equal sign
//DONE bug 4 = cant click number after equal sign
//DONE bug 5 = cant click equal sign if theres no operator
				or second number
//DONE bug 6 = cant change operator
//DONE bug 7 = cant do calculation if the second number has more 
				than 1 number and its 0, ex: 2 + 12 = 14 + 10
bug 8 = calculation order based on Math is wrong, ex: x and /
		is not prioritized
bug 9 = cant show on temporary screen
		calculation with first number is 0;
//DONEbug 10 =  cant click only coma after operator
//DONE bug 10 = not displaying right calculation on temporary Screen 
*/
